...
export default function Surveys() {
  return (
    <HelmetProvider>
      <Helmet>
        <title>Our Survey Services - AusPac</title>
        <meta
          name="description"
          content="Explore AusPac's expert survey services including marine, cargo, and environmental surveys."
        />
        <meta property="og:title" content="Our Survey Services - AusPac" />
        <meta
          ...
          {surveys.map((survey) => (
            ...
            >
              <motion.img
                ...
                style={{ height: "180px", maxHeight: "calc(45vw)" }}
